#!/usr/bin/env python3
"""Build a deterministic, repository-agnostic capability catalog as JSON + HTML."""
...
from mcp_policy import (HTTP_VERBS, POLICY_LIMIT_BYTES, PolicyBuildError,
...
def main():
    ...
    write_outputs(REPO_ROOT, REPO_ROOT / args.output, REPO_ROOT / args.metadata)
